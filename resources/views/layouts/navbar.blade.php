...
<nav class="navbar navbar-expand-lg py-3 bg-white  border-bottom border-gray-light">
                ...
                <div class="dropdown-menu collapse" id="dropdown-menu" style="width: 17rem; top:2.5rem">
                        ...
                        <ul class="dropdown-menu collapse submenu" id="collMenu" style="width: 18rem; top: -2.7rem;">
                            ...
                            <section class="main-nav-dropdown__section--with-header">
                                ...
                                <ul class="list-no-style">
                                    <li class="main-nav-dropdown__item">
                                        <a class="main-nav-dropdown__item-control color-charcoal"
                                            href="https://www.classcentral.com/starting-this-month" data-track-click="nav_click">
                                            <span>Starting this Month</span>
                                        </a>
                                    </li>
                                    <li class="main-nav-dropdown__item">
                                        <a class="main-nav-dropdown__item-control color-charcoal"
                                            href="https://www.classcentral.com/new-online-courses" data-track-click="nav_click">
                                            <span>New Online Courses</span>
                                        </a>
                                    </li>
                                    <li class="main-nav-dropdown__item">
                                        <a class="main-nav-dropdown__item-control color-charcoal"
                                            href="https://www.classcentral.com/most-popular-courses" data-track-click="nav_click">
                    ...
                    <li class="nav-item" data-bs-toggle="collapse" data-bs-target="#healthMenu">
                        ...
                        <ul class="dropdown-menu collapse submenu" id="healthMenu"
                            ...
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/nutrition-and-wellness"><span>Nutrition &amp; Wellness</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/disease-and-disorders"><span>Disease &amp; Disorders</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/public-health"><span>Public Health</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/health-care"><span>Health Care</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/nursing"><span>Nursing</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/anatomy"><span>Anatomy</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/veterinary-science"><span>Veterinary Science</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/cme"><span>Continuing Medical Education (CME)</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item mb-3">
                                <a class="main-nav-dropdown__item-control--highlighted"
                    ...
                    <li class="nav-item" data-bs-toggle="collapse" data-bs-target="#mathMenu">
                        ...
                        <ul class="dropdown-menu collapse submenu" id="mathMenu"
                            ...
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal" href="https://www.classcentral.com/subject/statistics">
                                    <span>Statistics &amp; Probability</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/foundations-of-mathematics"><span>Foundations of Mathematics</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/calculus"><span>Calculus</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/discrete-mathematics"><span>Discrete Mathematics</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/trigonometry"><span>Trigonometry</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/geometry"><span>Geometry</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/algebra"><span>Algebra</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal" href="https://www.classcentral.com/subject/precalculus">
                                    <span>Precalculus</span> </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/number-theory"><span>Number Theory</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/combinatorics"><span>Combinatorics</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/mathematical-logic"><span>Mathematical logic</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/linear-programming"><span>Linear Programming</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item mb-3">
                                <a class="main-nav-dropdown__item-control--highlighted"
                                    href="https://www.classcentral.com/subject/maths"><span>View all Mathematics</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item" data-bs-toggle="collapse" data-bs-target="#businessMenu">
                        ...
                        <ul class="dropdown-menu collapse submenu" id="businessMenu"
                            ...
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/management-and-leadership"><span>Management &amp; Leadership</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/finance"><span>Finance</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/entrepreneurship"><span>Entrepreneurship</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/marketing"><span>Marketing</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/strategic-management"> <span>Strategic Management</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/industry-specific"> <span>Industry Specific</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/business-intelligence"><span>Business Intelligence</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal" href="https://www.classcentral.com/subject/accounting">
                                    <span>Accounting</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/human-resources"><span>Human Resources</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/project-management"> <span>Project Management</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/sales"><span>Sales</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/design-thinking"><span>Design Thinking</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/business-software"><span>Business Software</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/risk-management"><span>Risk Management</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/csr"><span>Corporate Social Responsibility</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/customer-service"><span>Customer Service</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/nonprofit"><span>Nonprofit Management</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/innovation"><span>Innovation</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control color-charcoal"
                                    href="https://www.classcentral.com/subject/operations-management"><span>Operations Management</span>
                                </a>
                            </li>
                            <li class="main-nav-dropdown__item">
                                <a class="main-nav-dropdown__item-control--highlighted"
                                    href="https://www.classcentral.com/subject/business"><span>View all Business</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <div class="row border-top margin-top-medium padding-top-medium">
                        <a data-track-ga="[
                          ...
                          { &quot;category&quot;: &quot;nav_click&quot;, &quot;action&quot;: &quot;news&quot;, &quot;label&quot;: &quot;index&quot;}
                            ...
                            class="btn-white btn-medium horz-align-right relative" href="https://www.classcentral.com/report/">
                            Visit
    ...
    <div class="collapse navbar-collapse justify-content-md-end " id="mainNavbar" style="text-align: center;">
        <a href="https://www.classcentral.com/login" class="text-1 weight-semi color-charcoal">{{ __('home/navbar/navbar.Log In') }}</a>
        <span class="inline-block padding-horz-xxsmall color-charcoal">or</span>
        <a href="https://www.classcentral.com/signup" class="text-1 weight-semi color-charcoal">
